#tag DesktopWindow
Begin DesktopWindow wNewOrEditPeriod
   Backdrop        =   0
...
#tag Events dtEnd
	#tag Event
		Sub Opening()
		  me.SelectedDate = DateTime.Now.AddInterval(0,0,1)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events btnOK
	#tag Event
		Sub Pressed()
		  ...
		  If txtCaption.Text.Trim.Lowercase = "new period" Then
		    
		    Var m as new MessageDialog
		    m.Title = self.Title
		    m.Message = "Do you want to keep ""New period"" as the caption?"
